...
describe('Distributions', function() {
  ...
  describe('Uniform sample', function() {
      it('should work correctly and have the right mean and variance', function () {
      ...
      it('should be within the range', function () {
          ...
          for (var i=0; i < 1000; i++) {
              ...
              var sample_1 = sample[0];
              assert.ok(sample_1 >= -2 && sample_1 <= 20);
          }
      });

      it('probability density function', function () {
  ...
  describe('Discrete uniform sample', function () {
      it('should work correctly and have the right mean and variance', function () {
      ...
      it('should be within the range', function () {
          var distribution = distributions.discreteuniform(-2, 20);
          for (var i=0; i < 1000; i++) {
              var sample = distribution.sample();
              assert.equal(sample.length, 1);
              var sample_1 = sample[0];
  ...
  describe('Gaussian sample', function () {
      it('should work correctly and have correct mean and variance', function () {
      ...
      it('default to zero mean and one variance', function () {
      ...
      it('sample no argument gets one sample', function () {
        var distribution = distributions.gaussian(1, 4);
        var sample = distribution.sample();
  ...
  describe('Poisson sample', function() {
      it('should have the correct distribution, mean and variance', function () {
      ...
      it('should work with big mean', function () {
        var distribution = distributions.poisson(800);
        var sample = distribution.sample(100);

        assert.ok(isDrawnFromDistribution(sample, 'poisson_800'));
        assert.equal(distribution.mean, 800);
        assert.equal(distribution.variance, 800);
      });

      it('probability distribution function', function () {
  ...
  describe('Categorical sample', function() {
      it('should have correct proportions', function () {
      ...
      it('should only draw possible values', function () {
          var distribution = distributions.categorical({0: 0.5, '1': 0.25, '2': 0.25});
          ...
          for (var i=0; i < 100; i++) {
              ...
              var sample_1 = sample[0];
              assert.ok(sample_1 === '0' || sample_1 === '1' || sample_1 === '2');
          }
      });
  });
